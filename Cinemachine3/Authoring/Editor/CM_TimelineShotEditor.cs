...
//{
    ...
    internal sealed class CM_TimelineShotEditor : BaseEditor<CM_TimelineShot>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Rect rect;
            CM_VcamBase vcam
                = vcamProperty.exposedReferenceValue as CM_VcamBase;
            if (vcam != null)
        ...
        void DrawSubeditors(CM_VcamBase vcam)
        {
